...
DM_Ret_dict=portfolio_main(tickers,start,end,cha_name,ret_freq_use,q)[0]
Vol_Ret_mrg_df=portfolio_main(tickers,start,end,cha_name,ret_freq_use,q)[1]
EW_LS_pf_df=portfolio_main(tickers,start,end,cha_name,ret_freq_use,q)[2]
...
# print(get_avg(DM_Ret_dict['Daily'],2008))
# NVDA=-0.004241
Q1_ANSWER = 'NVDA'
...
#     Use the output dictionary, DM_Ret_dict, and auxiliary function in this script
#     to do the calculation.
# print(get_avg(DM_Ret_dict['Daily'],2008)['nvda'])
Q2_ANSWER = '-0.0042'
...
#     Use the output dictionary, DM_Ret_dict, and auxiliary function in this script
#     to do the calculation.
# print(get_avg(DM_Ret_dict['Monthly'],2019))
# APPL=0.056635
Q3_ANSWER = 'AAPL'
...
#     Use the output dictionary, DM_Ret_dict, and auxiliary function in this script
#     to do the calculation.
# print(get_avg(DM_Ret_dict['Monthly'],2019)['aapl'])
Q4_ANSWER = '0.0566'
...
#     to do the calculation.
# print(get_avg(Vol_Ret_mrg_df['tsla_vol'],2010))
Q5_ANSWER = '0.0414'
...
#     Use the output dataframe, Vol_Ret_mrg_df, and auxiliary function in this script
#     to do the calculation.
# print(get_avg(Vol_Ret_mrg_df['v_vol'],2008)/get_avg(Vol_Ret_mrg_df['v_vol'],2018))
Q6_ANSWER = '2.6'
...
# df=Vol_Ret_mrg_df[['tsla','tsla_vol']]
# print(df[df.index.year==2010])
# only last 5 month is effective
Q7_ANSWER = '5'
...
#     to do the calculation.
# print(get_avg(EW_LS_pf_df,2019).mean())
...
#      Use the output dataframe, EW_LS_pf_d, and auxiliary function in this script
#     to do the calculation
# print(get_cumulative_ret(EW_LS_pf_df['ls']))
Q10_ANSWER = '1.5980'
...
def t_stat(data, hypothesized_mean=0):
    t_statistic, p_value = stats.ttest_1samp(data, hypothesized_mean)
    return t_statistic, p_value

mean_val = EW_LS_pf_df['ls'].mean()
t_statistic, p_value = t_stat(EW_LS_pf_df['ls'])
print(f"Mean of 'ls': {mean_val}")
print(f"T-statistic: {t_statistic}")
print(f"Number of observations: {EW_LS_pf_df['ls'].count()}")
